...
#define __FAVOR_BSD
#include <netinet/tcp.h> //Plik naglowkowy dla TCP
#include <arpa/inet.h>
#include <netdb.h>
#include <unistd.h>
#include <string.h>
...
int main(int argc, char** argv) {
    ...
    struct tcphdr           *tcp_header     = (struct tcphdr *)(buff + sizeof(struct ip));
    
    /* Wskaznik na pseudo-naglowek (w buforze okreslonym przez 'buff'): */
    struct phdr             *pseudo_header  = (struct phdr *)(buff + sizeof(struct ip) + sizeof(struct tcphdr));
    ...
    /* Wyzerowanie przestrzeni reserved */
    tcp_header->res1                =       0;
